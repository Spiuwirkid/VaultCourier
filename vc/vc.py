...
class TelegramClient:
    ...
    def report_error(self, error_message: str):
        self.send_message(f"\u26a0\ufe0f <b>Error:</b> {error_message}")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: vc -f example1.txt example2.jpg --message 'Here are the files'" 
    )
        ...
        if args.file:
            for file_path in args.file:
                ...
                if not path.exists():
                    ...
                    client.send_file(path, args.message)
        elif args.directory:
            ...
            if not dir_path.exists():
                ...
                if zip_path:
                    client.send_file(zip_path, args.message)
                    zip_path.unlink()
